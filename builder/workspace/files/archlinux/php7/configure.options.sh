APXS2=$(which apxs)
OPTIONS="${OPTIONS} --prefix=/opt/php7"
OPTIONS="${OPTIONS} --exec-prefix=/opt/php7"
# Basic
...
OPTIONS="${OPTIONS} --with-config-file-path=/opt/php7/etc"
OPTIONS="${OPTIONS} --with-config-file-scan-dir=/opt/php7/etc/conf.d"
